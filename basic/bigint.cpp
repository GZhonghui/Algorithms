...
public:
    ...
    //  Addition
    bigint add(const bigint &that) const; // returns a new bigint that is the sum of the two bigints *this and that
    bigint operator+(const bigint &that) const; // returns a new bigint that is the sum of the two bigints *this and that
    ...
    bigint operator-(const bigint &that) const; // returns a new bigint that is the difference between the two bigints *this and that
